...
public interface IElasticService
{
    ...
    Task<UpdateResponse<AdvertElasticEntry>> UpdateAdvertAsync(AdvertElasticEntry advert,
        CancellationToken cancellationToken = default);

    Task<DeleteResponse> DeleteAdvertAsync(AdvertElasticEntry advert, CancellationToken cancellactionToken = default);

    Task<IEnumerable<AdvertElasticEntry>> SearchAdvertsAsync(SearchAdvertsParams searchParams,
        CancellationToken cancellationToken = default);
}