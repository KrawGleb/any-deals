...
{
    /// <inheritdoc />
    public partial class MergeMigrationsToRemoveOldOne : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    AllowedCardPayment = table.Column<bool>(type: "bit", nullable: true),
                    AllowedCashPayment = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchivatedByCustomer = table.Column<bool>(type: "bit", nullable: false),
                    ArchivatedByExecutor = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "A3BF16BB-378C-4350-8BFF-FF1ED9CB2915", 0, 0m, "f8f7f881-1a3d-46d6-a74e-17bcd658cc46", "krawcevitsch@gmail.com", false, false, null, "KRAWCEVITSCH@GMAIL.COM", "CREATOR", "AQAAAAIAAYagAAAAEB/hF/keKdkskDEYFdhZ7lHcIjurutz0c/qjUWulEFXc39EN4goFOXO060Dhs45Sfw==", null, false, "30114e5f-fa10-44df-81a8-9a250136a760", false, "Creator" });
